...
| --- | --- | --- | --- | --- |
| Rajvansh | G2-A on `rajvansh-ui` | PR #11 merged source-text preview and Eddy work through 179d98f. Combined 94 tests pass; final preview layout checked in four affected browser cases. Five reproduced draft-boundary defects fixed with regression tests. | API owner/private credential and live relay are unresolved. | Build the extension-side relay client and Generate/review states using GENERATION_HANDOFF; Eddy retains server/provider and proposal persistence. |
