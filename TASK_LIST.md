...
| UX2-A | Rajvansh | Now | Open saved maps with clear Edit, New graph and Generate with AI actions | DOING | User requests a saved-map-first opening view. On rajvansh-ui: separate viewing from editing, expose new graph creation, open selected-content AI tools directly, and offer supported Doc content from Drive without silently replacing saved maps or triggering AI. Reuse existing storage/generation APIs; G3 persistence and Eddy's backup work remain separate. |
